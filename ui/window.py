...
class ServeScanUI:
    ...
    def _build(
        ...
        controls = tk.Frame(root, bg=COLORS["surface"], height=74)
        controls.grid(row=2, column=0, sticky="ew")
        controls.grid_propagate(False)
        controls.columnconfigure(0, weight=1)
        controls.columnconfigure(1, minsize=112, uniform="action")
        controls.columnconfigure(2, minsize=112, uniform="action")
        controls.columnconfigure(3, minsize=112, uniform="action")
        ...
        self.mode_button = TouchButton(
            ...
            color=COLORS["text_muted"], hover=COLORS["text"], width=104,
        )
        self.mode_button.grid(row=0, column=1, padx=4, pady=10)

        self.upload_button = TouchButton(
            controls, text="Upload Video", icon="upload", command=on_upload_video,
            color=COLORS["primary"], hover=COLORS["primary_hover"], width=104,
        )
        self.upload_button.grid(row=0, column=2, columnspan=2, padx=4, pady=10)

        self.capture_button = TouchButton(
            controls, text="Capture", icon="capture", command=on_toggle_capture,
            color=COLORS["primary"], hover=COLORS["primary_hover"], width=104,
        )
        self.capture_button.grid(row=0, column=2, padx=4, pady=10)
        ...
        self.stop_button = TouchButton(
            ...
            color=COLORS["danger"], hover=COLORS["danger_hover"], width=104,
        )
        self.stop_button.grid(row=0, column=3, padx=4, pady=10)
